...
class CollisionNotifier {
    ...
    private Boolean light,proximity,gyro,linear,accel,gps=false;
    private Boolean DANGER_new=false,DANGER_old=null;
    ...
    private void check_danger(Context context) {
        ...
        gyro = flag_gyro_available.equals(GYROSCOPE_AVAIL) && (GYRO_DANGER_X.equals("TRUE") || GYRO_DANGER_Y.equals("TRUE") || GYRO_DANGER_Z.equals("TRUE"));

        linear = flag_linear_available.equals(LINEAR_AVAIL) && (LINEAR_DANGER_X.equals("TRUE") || LINEAR_DANGER_Y.equals("TRUE") || LINEAR_DANGER_Z.equals("TRUE"));

        accel = flag_accel_available.equals(ACCEL_AVAIL) && (ACCEL_DANGER_X.equals("TRUE") || ACCEL_DANGER_Y.equals("TRUE") || ACCEL_DANGER_Z.equals("TRUE"));

        gps = flag_gps_available.equals(GPS_AVAIL) && (GPS_DANGER_X.equals("TRUE") || GPS_DANGER_Y.equals("TRUE"));


        DANGER_new = (light || proximity || gyro || linear || accel || gps);
        ...
        if (!DANGER_new.equals(DANGER_old)) {
            ...
            prefs2.saveData("danger_global", String.valueOf(DANGER_new));
